                    ...
                    <div className="p-6">
                        ...
                        <p className="text-gray-700 mb-1">
                            Whether you want to implement Classic ML or DNN, there is a significant cost of data handling and training your first AI model.
                             <br/><Link href="aboutus"> <span className='text-green-600'>Talk to our experts</span> </Link>to maximize your chances of building a successful AI solution.
                        </p>
                ...
                <div className="bg-white rounded-lg shadow-lg transition-transform transform hover:scale-105" data-aos="zoom-in-up">
                    ...
                    <div className="p-6">
                        ...
                        <p className="text-gray-700 mb-1">
                            ...
                            organizing and planning launch events. <Link href="aboutus"> <span className='text-green-600'>Talk to our experts</span> </Link>.
                        </p>
                        <ul className="list-disc list-inside pl-5 space-y-2">
                        ...
                        <p className="text-gray-700 mb-1">
                            A crisp minimum feature set of your product defines its positioning. Whether it is a new innovation,
                             ...
                             we can strategize product feature research, design marketing collaterals,
                              and track competition so you stay ahead in the game  <Link href="aboutus"> <span className='text-green-600'>Talk to our experts</span> </Link>.
                        </p>
                        <ul className="list-disc list-inside pl-5 space-y-2">
                ...
                <div className="bg-white rounded-lg shadow-lg transition-transform transform hover:scale-105" data-aos="zoom-in-up">
                    ...
                    <div className="p-6">
                        ...
                        <p className="text-gray-700 mb-4">
                            ...
                            meet your interview panel.<br/>  <Link href="aboutus"> <span className='text-green-600'>Talk to our experts</span> </Link>to know more, at no cost.
                        </p>
                        <ul className="list-disc list-inside pl-5 space-y-2">
