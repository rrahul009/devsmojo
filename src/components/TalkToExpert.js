        ...
        <div className="p-2 px-2 bg-gray-100 min-h-screen mt-5 gap-5" data-aos="zoom-in-up">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white p-2 rounded-lg shadow-lg transition-transform transform hover:scale-105" data-aos="zoom-in-up">
                    ...
                    <div className="p-6">
                        <h3 className="text-2xl font-semibold text-black mb-1">How you can leverage AI</h3>
                        <p className="text-gray-700 mb-1">
                            ...
                            <br /><Link href="/aboutus/#schedular"> <span className='text-blue-600 font-bold'>Talk to our experts</span> </Link>to maximize your chances of building a successful AI solution.
                        </p>
                ...
                <div className=" bg-white rounded-lg p-2 shadow-lg transition-transform transform hover:scale-105" data-aos="zoom-in-up">
                    ...
                    <div className="p-6">
                        <h3 className="text-2xl font-semibold text-black mb-1">How you can fast track your MVP</h3>
                        <p className="text-gray-700 mb-1">
                            ...
                            organizing and planning launch events.
                             <Link href="/aboutus/#schedular"> <span className='text-blue-600 font-bold'>Talk to our experts</span> </Link>.
                        </p>
                        <ul className="list-disc list-inside pl-5 space-y-2">
                ...
                <div className="bg-white rounded-lg p-2 shadow-lg transition-transform transform hover:scale-105" data-aos="zoom-in-up">
                    ...
                    <div className="p-6">
                        <h3 className="text-2xl font-semibold text-black mb-1">We can Market Research your next Product</h3>
                        <p className="text-gray-700 mb-1">
                            ...
                            and track competition so you stay ahead in the game  <Link href="/aboutus/#schedular"> <span className='text-blue-600 font-bold'>Talk to our experts</span> </Link>.
                        </p>
                        <ul className="list-disc list-inside pl-5 space-y-2">
                ...
                <div className="bg-white rounded-lg p-2 shadow-lg transition-transform transform hover:scale-105" data-aos="zoom-in-up">
                    ...
                    <div className="p-6">
                        <h3 className="text-2xl font-semibold text-black mb-1">Learn about our Talent Selection process</h3>
                        <p className="text-gray-700 mb-4">
                            ...
                            meet your interview panel.<br />  <Link href="/aboutus/#schedular"> <span className='text-blue-600 font-bold'>Talk to our experts</span> </Link>to know more, at no cost.
                        </p>
                        <ul className="list-disc list-inside pl-5 space-y-2">
