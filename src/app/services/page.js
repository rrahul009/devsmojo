...
const ServicePage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Mobile App  Android*/}
      <section id="mobile-development" className="py-5 bg-gray-100 min-h-screen flex flex-col items-center w-full mt-4" data-aos="zoom-in-up">
        <div className="container bg-white p-5 mx-auto px-6 lg:px-12 w-full">
          <h2 className="text-4xl font-bold mb-2 text-blue-600 text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center md:items-start space-y-8 md:space-y-0 md:space-x-12">
            ...
            <div className=" p-6 rounded-lg  flex-1 ">
              <h3 className="text-4xl font-semibold text-blue-600 text-center md:text-start mb-4">Android Development</h3>
      ...
      {/* Mobile app IOS */}
      <section  className="py-6 min-h-screen flex flex-col items-center" >
        <div className="container mx-auto px-6 lg:px-12">
          <div className="flex flex-col md:flex-row justify-start items-center md:items-start space-y-8 md:space-y-0 md:space-x-12">
            ...
            <div className=" p-6 rounded-lg  flex-1 ">
              <h3 className="text-4xl font-semibold text-blue-600 text-start mb-4">iOS Development</h3>
              <p className="text-gray-700 mb-6">
      ...
      <section id="backend" className="bg-gray-200 py-12 mt-6" data-aos="zoom-in-up">
      <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-8">
              ...
              <div
                  className="bg-white shadow-lg rounded-lg p-6 w-full sm:w-80 lg:w-1/3 transition-transform transform hover:scale-105"
                  data-aos="zoom-in-up"
              >
                  <div className="flex items-center mb-4">
                      <BuildIcon className="h-12 w-12 text-blue-600" />
                      <h3 className="text-2xl font-semibold text-blue-600 ml-4">
                          Custom Application Development
                      </h3>
                  </div>
              ...
              >
                  <div className="flex items-center mb-4">
                      <CloudIcon className="h-12 w-12 text-red-600" />
                      <h3 className="text-2xl font-semibold text-blue-600 ml-4">
                          Cloud Solutions
                      </h3>
                  </div>
